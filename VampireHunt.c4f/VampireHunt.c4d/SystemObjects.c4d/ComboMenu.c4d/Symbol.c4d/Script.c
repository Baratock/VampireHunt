...
{
	if (GetAction() == "Throw") return "4";
	if (GetAction() == "Up"   ) return "5";
	if (GetAction() == "Dig"  ) return "6";
	if (GetAction() == "Left" ) return "L";
	if (GetAction() == "Down" ) return "2";
	if (GetAction() == "Right") return "R";
}
