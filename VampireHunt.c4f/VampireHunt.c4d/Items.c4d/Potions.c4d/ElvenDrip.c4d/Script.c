...
public func Basic()    { return ELRT; }
public func Number()   { return 4;    }
public func Intensity(){ return 100;  }

///---Qualities---///

protected func Initialize()
{ 
	AddEffect("Potion",this,100,1,this,0);
}
...
{
	// equal effect sum up to one (e.g. if one drunk two potion)
	if(szNewEffectName == "ManaPotion") return -2;
}
