...
private func ReproductionRate()     { return 15; }
...
public func IsStanding() { return(GetCategory(this) & C4D_StaticBack); }
...
{
	[$TxtPick$|Image=GetID(this)|Condition=IsStanding]
	if(!fOrg)
	{
		Pick();
	}
